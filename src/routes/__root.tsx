...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800;900&family=Grand+Hotel&family=Inter:wght@400;500;600;700;800&family=Fredoka:wght@600;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
    ...
    })(window, document, "clarity", "script", "yhzq4daelc");`,
      },
    ],
  }),
